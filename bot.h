...
public:
    ...
    void initializeResponder(string fileName) {
        ...
        for (int i = 0; i < numberOfLines; i++) {
            ...
            index++;
            while (index < line.length() && line[index] != '\0') {
...
public:
    ...
    void inputRefereeDetails() {
        ...
        while (true) {
            ...
            if (!validateCnic(referee1.cnic)) {
                cout << "Invalid CNIC! Must be exactly 13 digits.\n";
                continue;
            }
            if (referee1.cnic == cnic) {
                cout << "Error: Referee CNIC cannot match Applicant CNIC. Please enter a different CNIC.\n";
                continue;
            }
            break;
        }
        ...
        while (true) {
            ...
            if (!validateContactNumber(referee1.phoneNumber)) {
            ...
            if (referee1.phoneNumber == contactNumber) {
                cout << "Error: Referee Phone cannot match Applicant Phone. Please enter a different number.\n";
                continue;
            }
            break;
        }
        ...
        while (true) {
            ...
            if (!validateCnic(referee2.cnic)) {
                cout << "Invalid CNIC! Must be exactly 13 digits.\n";
                continue;
            }
            if (referee2.cnic == cnic) {
                cout << "Error: Referee CNIC cannot match Applicant CNIC.\n";
                continue;
            }
            if (referee2.cnic == referee1.cnic) {
                cout << "Error: Referee 2 cannot have the same CNIC as Referee 1.\n";
                continue;
            }
            break;
        }
        ...
        while (true) {
            ...
            if (!validateContactNumber(referee2.phoneNumber)) {
                cout << "Invalid Phone Number! Must be 11 digits starting with 0 or 13 digits starting with +92.\n";
                continue;
            }
            if (referee2.phoneNumber == contactNumber) {
                cout << "Error: Referee Phone cannot match Applicant Phone.\n";
                continue;
            }
            if (referee2.phoneNumber == referee1.phoneNumber) {
                cout << "Error: Referee 2 cannot have the same Phone Number as Referee 1.\n";
                continue;
            }
            break;
        }
    ...
    while (true) {
        ...
        if (input == "H" || input == "h") {
            ...
            while (true) {
                cout << "Enter Area (1-4): ";
                getline(cin, area);
                if (!area.empty() && area[0] >= '1' && area[0] <= '4') {
